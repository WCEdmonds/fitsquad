      ...
      <main className="flex-1">
        <section className="relative w-full pt-16 pb-8 md:pt-24 md:pb-12 lg:pt-32 lg:pb-16 overflow-hidden">
           <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 to-background/40"></div>
           </div>
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center text-center">
              <div className="flex flex-col justify-center space-y-6 max-w-4xl mx-auto">
                <div className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none animate-in fade-in slide-in-from-bottom-4 duration-1000 text-white drop-shadow-lg">
                    Revolutionize Your Unit's Fitness
                  </h1>
                  <p className="max-w-[700px] text-white drop-shadow-md text-lg md:text-xl lg:text-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
