...
/**
 * Sample soldiers with realistic ACFT scores (0-100 scale) and fitness data
 * ACFT Scoring: 100 = excellent, 60 = minimum standard, below 60 = fail
 */
export const DEMO_SOLDIERS: Omit<Soldier, 'id' | 'teamId' | 'teamName'>[] = [
  {
    ...
    lastName: 'Johnson',
    rank: 'Sergeant',
    mdl: 92,       // Excellent deadlift
    hrp: 88,       // Very good push-ups
    sdc: 85,       // Good sprint-drag-carry
    plk: 80,       // Good plank
    twoMileRun: 78, // Solid run time
    gender: 'Male',
    weight: 185,
    height: 70,
